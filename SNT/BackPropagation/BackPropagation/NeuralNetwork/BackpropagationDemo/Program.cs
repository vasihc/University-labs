...
namespace BackpropagationDemo
{
    class BackPropProgram
    {
        static void Main(string[] args)
        {
            ...
            int numInput = 9; // number features
            int numHidden = 5;
            ...
            ShowMatrix(trainData, 9, 1, true);
            Console.WriteLine("Test data:");
            ShowMatrix(testData, 9, 1, true);
          ...
          int numOutput, int numRows, int seed)
        {
            ...
            var dataSets = DataSet.ImportDatasets("data.txt");
            for (var r = 0; r < dataSets.Count; r++)
            {
                double[] inputs = dataSets[r].Values;
                double[] outputs = dataSets[r].Targets;
